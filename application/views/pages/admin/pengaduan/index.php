  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-body">
          <?php echo form_open($cname.'/insert',['id'=>'form-pengaduan-post']); ?>
          <input type="hidden" class="form-control" name="id_pengaduan" placeholder="">
          <div class="form-group">
            <label>Nama User</label>
            <input type="text" class="form-control" name="id_user" placeholder="" disabled>
          </div>
          <div class="form-group">
            <label>Kategori</label>
            <input type="text" class="form-control" name="id_kategori" placeholder="" disabled>
          </div>
          <div class="form-group">
            <label>Laporan</label>
            <input type="text" class="form-control" name="isi_laporan" placeholder="" disabled>
          </div>
          <div class="form-group">
            <label>Waktu Laporan</label>
            <input type="text" class="form-control" name="waktu_lapor" placeholder="" disabled>
          </div>
          <div class="form-group">
            <label>Status</label>
            <select class="form-control" name="status">
...
<script>
  ...
  $(document).ready(function() {
    ...
    table = $('#table-data').DataTable({
      ...
      },
      {
        ...
        "data": (data, type, row) => {
          let ret = "";
          ret += ' <a class="btn btn-info btn-sm" href="#" onclick="edit_pengaduan('+data.id_pengaduan+')"><i class="fas fa-pencil-alt"></i> Edit</a>';
          ret += ' <a class="btn btn-danger btn-sm" href="#" onclick="delete_jabatan(this)" data-id="'+data.id_pengaduan+'"><i class="fas fa-trash-alt"></i> Delete</a>';
          return ret;
        }
      }
      ]
  ...
  var form_reset = () => {
    table.ajax.reload(null,false);
    $('form#form-pengaduan-post').find('input,select').val('');
  }
