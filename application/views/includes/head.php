  ...
  <link rel="shortcut icon" href="<?php echo base_url('assets/img/logo-baru.png') ?>">
  <!-- Font Awesome Icons -->
  ...
  <!-- dropify -->
  <link rel="stylesheet" href="<?php echo base_url('assets/plugins/dropify/dropify.min.css') ?>">
